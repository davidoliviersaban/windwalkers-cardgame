...
$this->characters = [
    ...
    56 => [
        ...
        'is_leader' => true,
        'tier' => 3,
        'power' => clienttranslate(':tap:: :tap: :card: <b>TRAÎNE</b> pour utiliser son pouvoir.'),
        'power_type' => 'discard',
    ...
    61 => [
        ...
        'is_leader' => true,
        'tier' => 1,
        'power' => clienttranslate(':tap:: :tuile: villages = :tuile: villes: Ignorez tous :d6-black-white-green: et vous recrutez tout type de :card:'),
        'power_type' => 'tap',
    ...
    82 => [
        ...
        'position' => 'pack',
        'tier' => 3,
        'power' => clienttranslate(':tap:: :tap: 1 autre :card: et gagnez +3 :moral:'),
        'power_type' => 'tap',
    ...
    98 => [
        ...
        'position' => 'traine',
        'tier' => 2,
        'power' => clienttranslate(':discard:: Lancez +2 :d6-violet:, :rest: 1 autre :card: <b>Torantor</b>.'),
        'power_type' => 'discard',
